...
export class PersonaService {
  ...
  private url = environment.api + '/persona/GetPersonas';
  private urlDocumento = environment.api + '/persona';
  ...
  getDocumento(row:SearchResult){
    ...
    return this.http.get<WebApiResponse>(this.urlDocumento + '/GetDocumento', { params: queryParams });
  }
